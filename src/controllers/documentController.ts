...
export const uploadDocumentValidation = [
  body('type')
    .isIn(['INSURANCE', 'UCC_FILING', 'AUTHORITY', 'SAFETY_RECORD', 'BILL_OF_SALE', 'ARTICLES_OF_INCORPORATION', 'EIN_LETTER', 'LOSS_RUNS', 'LETTER_OF_RELEASE', 'PURCHASE_AGREEMENT', 'SIGNED_AGREEMENT', 'PAYMENT_PROOF', 'OTHER'])
